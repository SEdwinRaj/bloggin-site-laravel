    ...
    <?php if(!empty($d2)): ?>
        ...
        <div class="content">
            ...
            <div class="delete-btn">
                <form action="<?php echo e(route('delete', [$d->id, $username])); ?>" method="post">
                    <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>
        ...
        <div class="side-nav">
            ...
            <div class="side-nav-content">
                <h3 class="name"><?php echo e($username); ?></h3>
            </div>
            <div class="side-nav-content">
                <a href="/account" class="btn-side-nav">Account</a>
            </div>
            <div class="side-nav-content">
                <a href="/dth/<?php echo e($username); ?>" class="btn-side-nav">Home</a>
            </div>
            <div class="side-nav-content">
                <a href="/create/page/<?php echo e($username); ?>" class="btn-side-nav">Create blog</a>
            </div>
            <div class="side-nav-content">
...
</html><?php /**PATH C:\Users\edwin\Downloads\mini project\bloggin-site-laravel-main\resources\views/dashboard.blade.php ENDPATH**/ ?>